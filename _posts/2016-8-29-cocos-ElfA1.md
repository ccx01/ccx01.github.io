...
之前一直不接受游戏引擎，原因是个人想法有点狭隘，我太在意别人的看法，不希望听到，“哦，你这游戏是用引擎做的吧”，而且说话的口气好像，“切，要是有游戏引擎我也能做，这么简单的东西。”

现在想想，真蠢。

其实以前也有用过一些引擎，比如RPG大师和mugen，box2d.js。但是有段时间就是觉得，至少js引擎我自己可以写，还能随时修改源码，方便多了~然后就弄了个<a href="https://github.com/ccx01/T-night" target="_blank">T-night</a>（<a href="https://github.com/ccx01/game" target="_blank">jquery版</a>）……后来……被意义论打败了，想先出个容易看见成果的东西。

不过忽然要借助游戏引擎，主要是最近下载了个unity3d做的ios游戏，优化的实在太糟糕，于是脑袋里忽然就闪过个念头，我去试试用unity3d做个游戏看看吧。
...
因此相对于其他的**传统的游戏引擎**来说，cocos creator与其说是游戏引擎，不如说更像flash一类的开发工具，它没有特定的游戏类型的限制，这导致它的开发难度，或者说学习成本相对来说偏高。这感觉就像用RPG制作大师制作一个格斗游戏或用mugen做一个魔兽争霸一样。
