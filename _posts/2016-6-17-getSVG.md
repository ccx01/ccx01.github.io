---
layout: post
title:【泛红的蓝海】首先你要有个SVG
keywords: Sign,Sign的博客,技术文章,web开发,SVG
description: 这一开始是内网的一篇文章，以个人名义写的时候，还是比较随意的，但是后来说是发到团队公众号上，然后就改了不少。
tags: [web]
---
>这一开始是内网的一篇文章，以个人名义写的时候，还是比较随意的，但是后来说是发到团队公众号上，然后就改了不少。这过程总觉得自己莫名的给自己不>少奇怪的压力，不好好写的话会对团队形象造成不好影响吗？我这样的乱跳的文风会让别人不适应吗？这样幅度跨越较大的文章会让人怀疑团队的专业性吗？
>
...
![PSD](/img/2016-6-17-getSVG/e1.png)

而SVG长这样的：

![PSD](/img/2016-6-17-getSVG/e2.gif)

![PSD](/img/2016-6-17-getSVG/e3.jpg)

这就是传说中上天入地无所不能的SVG吗？！！！！

![PSD](/img/2016-6-17-getSVG/e4.jpg)
...
![PSD](/img/2016-6-17-getSVG/e5.jpg)

![PSD](/img/2016-6-17-getSVG/e6.jpg)
...
![PSD](/img/2016-6-17-getSVG/e7.jpg)

看这边，我们要的是这个彩色带子，不是人物剪影哈

![PSD](/img/2016-6-17-getSVG/e8.png)

图层

![PSD](/img/2016-6-17-getSVG/e9.png)
...
![PSD](/img/2016-6-17-getSVG/e10.png)
...
![PSD](/img/2016-6-17-getSVG/e11.png)

在AI中打开EPS，适当的进行缩放，并编辑画板，保证将所有的路径包含在画板中

![PSD](/img/2016-6-17-getSVG/e12.png)

对齐左上角，另外svg图形大小不影响图片体积，因为svg是矢量图，对齐左上角可以随意对SVG进行缩放，以方便输出后的展示。

![PSD](/img/2016-6-17-getSVG/e13.jpg)

另存为svg，选项依然默认

现在，看一下我们得到的SVG

![PSD](/img/2016-6-17-getSVG/e14.jpg)

![PSD](/img/2016-6-17-getSVG/e15.jpg)

这是SVG？打开SVG文件看下：

![PSD](/img/2016-6-17-getSVG/e16.jpg)

好像没啥毛病。代码部分：

![PSD](/img/2016-6-17-getSVG/e17.gif)

这样其实还好，有时候还会是这样的：

![PSD](/img/2016-6-17-getSVG/e18.gif)
...
![PSD](/img/2016-6-17-getSVG/e19.gif)

很好，看一下结果吧

![PSD](/img/2016-6-17-getSVG/e20.gif)
...
![PSD](/img/2016-6-17-getSVG/e21.jpg)

![PSD](/img/2016-6-17-getSVG/e22.jpg)

好，在style里加个 path{fill:#f00;}就有颜色了

![PSD](/img/2016-6-17-getSVG/e23.jpg)

![PSD](/img/2016-6-17-getSVG/e24.jpg)
...
![PSD](/img/2016-6-17-getSVG/e25.jpg)

先ctrl加左键点击图层，获取图层轮廓

![PSD](/img/2016-6-17-getSVG/e26.jpg)

选择线框工具

![PSD](/img/2016-6-17-getSVG/e27.png)

然后右键选区，建立工作路径，容差可根据实际情况调整

![PSD](/img/2016-6-17-getSVG/e28.jpg)

然后直接导出路径到AI就好了，不需要先转为EPS

![PSD](/img/2016-6-17-getSVG/e29.jpg)

当然导出的AI一样也是没有颜色信息的

![PSD](/img/2016-6-17-getSVG/e30.jpg)
...
![PSD](/img/2016-6-17-getSVG/e31.jpg)

好多不认识的标签呢……

![PSD](/img/2016-6-17-getSVG/e32.gif)

………………

是这样的，你试着右键然后“建立复合路径”，然后再另存为SVG

![PSD](/img/2016-6-17-getSVG/e33.jpg)

哎呀妈呀，我那么多图形只剩一个path了！！！！

![PSD](/img/2016-6-17-getSVG/e34.gif)

冷静！！！

要不试试单独对每一个图形进行“建立复合路径”，然后再另存为SVG

![PSD](/img/2016-6-17-getSVG/e35.jpg)

好了，都变成`<path>`了

![PSD](/img/2016-6-17-getSVG/e36.gif)
...
![PSD](/img/2016-6-17-getSVG/e37.png)

而当viewBox的大小和svg不同时，viewBox在屏幕上的显示会缩放至svg同等大小。（高宽非等比例缩放）

![PSD](/img/2016-6-17-getSVG/e38.png)
...
<a href="http://www.zhangxinxu.com/wordpress/?p=4323">http://www.zhangxinxu.com/wordpress/?p=4323</a>

另外关于用户单位，大家可以看这里

<a href="https://developer.mozilla.org/zh-CN/docs/Web/SVG/Tutorial/Positions">https://developer.mozilla.org/zh-CN/docs/Web/SVG/Tutorial/Positions</a>
...
![PSD](/img/2016-6-17-getSVG/e39.png)
...
![PSD](/img/2016-6-17-getSVG/e40.png)
...
![PSD](/img/2016-6-17-getSVG/e41.png)
...
![PSD](/img/2016-6-17-getSVG/e42.png)
...
<a href="http://www.webhek.com/how-svg-line-animation-works/">http://www.webhek.com/how-svg-line-animation-works/</a>

stroke-dasharray 值是一组数组，没数量上限，每个数字交替表示划线与间隔的宽度。

![PSD](/img/2016-6-17-getSVG/e43.png)
...
![PSD](/img/2016-6-17-getSVG/e44.gif)
...
<a href="https://developer.mozilla.org/zh-CN/docs/Web/SVG">https://developer.mozilla.org/zh-CN/docs/Web/SVG</a>

<a href="https://developer.mozilla.org/zh-CN/docs/Web/SVG/Tutorial/Positions">https://developer.mozilla.org/zh-CN/docs/Web/SVG/Tutorial/Positions</a>

<a href="http://www.zhangxinxu.com/wordpress/?p=4323">理解SVG的viewport,viewBox,preserveAspectRatio</a>

<a href="http://www.webhek.com/how-svg-line-animation-works/">SVG技术入门：线条动画实现原理</a>